...
INSERT INTO EMP_DDL VALUES(9007, '혜린', '뉴진스', 9000, SYSDATE, 10000, 2000, 10);
...
INSERT INTO EMP_DDL VALUES(90010, '유나', '잇지', 9000, SYSDATE, 10000, 2000, 10, '+82010-1234-5678');
INSERT INTO EMP_DDL VALUES(90011, '예지', '잇지', 9000, SYSDATE, 10000, 2000, 1000, '+82010-1234-5678');
...
TRUNCATE TABLE EMP_RENAME;  -- DDL 명령어
...
CREATE TABLE TABLE_NOTNULL(
    ...
    LOGIN_PDW VARCHAR2(20) NOT NULL,
    TEL VARCHAR2(20)

);

INSERT INTO TABLE_NOTNULL(LOGON_ID, LOGIN_PDW, TEL) VALUES('JKS2024', 'SPHB8250', NULL);
INSERT INTO TABLE_NOTNULL(LOGON_ID, LOGIN_PDW, TEL) VALUES('JKS2024', 'SPHB8250', '010-1234-5678');
...
INSERT INTO TABLE_UNIQUE(LOGIN_ID, LOGIN_PDW, TEL) VALUES('JKS2024', 'SPHB8250', NULL);
INSERT INTO TABLE_UNIQUE(LOGIN_ID, LOGIN_PDW, TEL) VALUES(NULL, 'SPHB8250', NULL);
...
INSERT INTO EMP_FK VALUES(9000, '강백호', '농구선수', 8000, 2300, 1200, 10);
...
-- EX) ID 및 PASSWORD 길이제한
-- EX) 유유효 값 범위 확인(나이/ 성적/ 전화번호/이메일)
CREATE TABLE TABLE_CHECK (
LOGIN_ID VARCHAR2(20) PRIMARY KEY,
LOGIN_RWD VARCHAR2(20) CHECK(LENGTH(LOGIN_PWD) >= 5),
TEL VARCHAR2(20)
);

INSERT INTO TABLE_CHECK VALUES('JKS2024', 'SPHB2', '010-1236-4567');
